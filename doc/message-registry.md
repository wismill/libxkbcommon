...
| [XKB-502] | `unsupported-machine-builder-update` | Unsupported xkb_machine_builder update type | Error |
...
### XKB-502 – Unsupported machine builder update {#XKB-502}

<dl>
  <dt>Since</dt><dd>1.14.0</dd>
  <dt>Type</dt><dd>Error</dd>
  <dt>Summary</dt><dd>Unsupported xkb_machine_builder update type</dd>
</dl>
