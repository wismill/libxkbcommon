...
static_assert(XKB_MACHINE_BUILDER_UPDATE_SHORTCUT_LAYOUT >= 0 &&
              XKB_MACHINE_BUILDER_UPDATE_SHORTCUT_LAYOUT < UINT32_WIDTH, "");
...
enum xkb_enumerations_values {
    ...
    XKB_MACHINE_BUILDER_UPDATE_TYPE_VALUES
        ...
        | (1u << XKB_MACHINE_BUILDER_UPDATE_SHORTCUT_LAYOUT)
    ,
...
static const uint32_t xkb_error_code_values[] = {
    ...
    XKB_ERROR_UNSUPPORTED_MACHINE_BUILDER_UPDATE,
...
static const uint32_t xkb_feature_values[] = {
    ...
    XKB_FEATURE_ENUM_MACHINE_BUILDER_UPDATE_TYPE,
