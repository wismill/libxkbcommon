...
enum xkb_action_controls {
     ...
     * Overlay controls
     */
    CONTROL_OVERLAY_ALL_V1 = (CONTROL_OVERLAY1 | CONTROL_OVERLAY2),
    CONTROL_OVERLAY_ALL =
        (CONTROL_OVERLAY_ALL_V1 |
         CONTROL_OVERLAY3 | CONTROL_OVERLAY4 |
         CONTROL_OVERLAY5 | CONTROL_OVERLAY6 |
    ...
    CONTROL_ALL_BOOLEAN = (CONTROL_ALL_BOOLEAN_V1 | CONTROL_OVERLAY_ALL),
    /* All the boolean controls modifiable via the API */
    CONTROL_API_BOOLEAN = (CONTROL_ALL_BOOLEAN & ~CONTROL_OVERLAY_ALL),
...
enum {
    _LAST_XKB_EVENT_TYPE = XKB_EVENT_TYPE_SWITCH_VIRTUAL_CONSOLE,
};
