...
static const struct xkb_message_entry xkb_messages[] = {
    ...
    {XKB_ERROR_UNSUPPORTED_KEYMAP_FORMAT_, "Unsupported keymap format"},
    ...
    {XKB_ERROR_LAYOUT_COUNT_LIMIT_EXCEEDED_, "Layout count limit exceeded"},
    ...
    {XKB_ERROR_UNEXPECTED_STATE_MODE_, "Unexpected state mode"},
    ...
    {XKB_ERROR_UNSUPPORTED_KEYMAP_SERIALIZATION_FLAGS_, "Unsupported keymap serialization flags"},
